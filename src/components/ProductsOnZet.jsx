...
const ProductsOnZet = () => {
    ...
    return (
        <div className='bg-blue-50 h-[100vh]'>
            ...
            <div data-aos="fade-up" className='grid md:grid-cols-2 gap-10 w-[80vw] mx-auto relative z-10'>
                <Tilt scale={scale} transitionSpeed={2000}>
                    <div className='flex gap-4 items-center bg-green-100 hover:bg-pink-50 rounded px-10 py-6'>
                        <div>
                            <Image className='h-52 w-64  grayscale hover:grayscale-0' src={product3} alt='product1' />
                        </div>
                        <div className='mt-2'>
                ...
                <Tilt scale={scale} transitionSpeed={2000}>
                    <div className='flex gap-4 items-center bg-yellow-100 hover:bg-pink-50  rounded px-10 py-6'>
                        <div>
                            <Image className='h-52 w-64 grayscale hover:grayscale-0 ' src={product4} alt='product1' />
                        </div>
                        <div className='mt-2'>
                ...
                <Tilt scale={scale} transitionSpeed={1000}>
                    <div className='flex gap-4 items-center bg-red-100  hover:bg-pink-50  rounded px-10 py-6'>
                        <div>
                            <Image className='h-52 w-64 grayscale hover:grayscale-0' src={product2} alt='product1' />
                        </div>
                        <div className='mt-2'>
                ...
                <Tilt scale={scale} transitionSpeed={2000}>
                    <div className='flex gap-4 items-center bg-orange-100 hover:bg-pink-50  rounded px-10 py-6'>
                        <div>
                            <Image className='h-52 w-64  grayscale hover:grayscale-0' src={product1} alt='product1' />
                        </div>
                        <div className='mt-2'>
